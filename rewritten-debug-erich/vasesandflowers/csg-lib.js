...
class CSG {
    ...
    newintersect(csg) {
        ...
        // a.build(b.allPolygons());
        // b.build(a.allPolygons()); //creates gorgeous diseases
        a.invert();
        return CSG.fromPolygons(a.allPolygons());
    }
    ...
    newunion(csg) {
       ...
       b = undefined
        ...
        // a.build(b.allPolygons()); //created gorgeous diseases
        return CSG.fromPolygons(a.allPolygons());
    }

    newnewintersect(csg ,csg2){

        let a = new Node(this.clone().polygons);
        let b = new Node(csg.clone().polygons);

        // let a2 = new Node(this.clone().polygons);
        // let b2 = new Node(csg.clone().polygons);
        ...
        // return CSG.fromPolygons(a2.allPolygons());
    }
