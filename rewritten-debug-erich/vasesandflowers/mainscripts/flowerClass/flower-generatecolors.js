Flower.prototype.generateColors = function(flowerNum, startFlowerColor=false){
  ...
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`))
  // color = (color + increment*1)%360
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`))
  // color = (color + increment*2)%360
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${93}%)`))
  i=i+3
  // color = (color + increment*1)%360
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`))
...
if(fxrand()<0.5){
  if(((color + this.increment*2)%360) > 70 && ((color + this.increment*2)%360) < 190 ){
  ...
  this.flowerColorSchemes.push("lightCenter")
    ...
    s = 90;
      ...
      // color = (color + this.increment*2)%360
      l = l+0
      rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${50}%)`))
      i=i+3
      // color = (color + this.increment*1)%360
      l = l+0
      rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`))
  ...
  // color = (color + increment*2)%360
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${10}%)`))
  i=i+3
  // color = (color + increment*1)%360
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`))
  ...
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${23}%)`))
  i=i+3
  ...
  l = l+0
  rawColors.push(new Color(`hsl(${((color+(fxrand()*5*posNegDir))%360)}, ${s}%, ${5}%)`))
  i=i+3
...
let increment =  this.increment*-1
this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*(posNeg*-1)))%360) +(fxrand()*5*posNegDir))%360)}, ${s}%, ${l-20}%)`)
} else {
this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l-20}%)`)
}
...
let increment =  this.increment*-1
c3 = new Color(`hsl(${((((this.startColorHue+(this.increment*2*(posNeg*-1)))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`)
} else {
c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`)
}
    ...
    if(((this.startColorHue+(this.increment*posNeg))%360) > 70 && ((this.startColorHue+(this.increment*posNeg))%360) < 190 ){
let increment =  this.increment*-1
this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*(posNeg*-1)))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
} else {
this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
}
    ...
    if((((this.startColorHue+((this.increment*2)*posNeg))%360)%360) > 70 && (((this.startColorHue+((this.increment*2)*posNeg))%360)%360) < 190 ){
let increment =  this.increment*-1
c3 = new Color(`hsl(${((((this.startColorHue+(this.increment*2*(posNeg*-1)))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
} else {
c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
}
    ...
    this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l-30}%)`)
    let c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l-30}%)`)
    ...
    rawColors.push(color4)
       ...
       let posNeg = fxrand() < 0.5 ? -1 : 1
              ...
              this.startFlowerColor = new Color(`hsl(${((this.startColorHue+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
 
 
 
 
    this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l+25}%)`)
    let c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
  ...
  if(fxrand()<1){ //<0 is ugly
    ...
    let posNeg = fxrand() < 0.5 ? -1 : 1
            ...
            if(((this.startColorHue+(this.increment*posNeg))%360) > 70 && ((this.startColorHue+(this.increment*posNeg))%360) < 190 ){
let increment =  this.increment*-1
this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*(posNeg*-1)))%360)+(fxrand()*5*posNegDir))%360)}, ${100}%, ${l-10}%)`)
} else {
this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${100}%, ${l-10}%)`)
}
...
let c3
  if(((this.startColorHue+(this.increment*posNeg))%360) > 70 && ((this.startColorHue+(this.increment*posNeg))%360) < 190 ){
let increment =  this.increment*-1
c3 = c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*(posNeg*-1)))%360)+(fxrand()*5*posNegDir))%360)}, ${100}%, ${l}%)`)
} else {

c3 = c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${100}%, ${l}%)`)
}
...
let c3
  if(((this.startColorHue+(this.increment*posNeg))%360) > 70 && ((this.startColorHue+(this.increment*posNeg))%360) < 190 ){
let increment =  this.increment*-1
c3 = c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*(posNeg*-1)))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
} else {

c3 = c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${85}%, ${l}%)`)
}
  ...
  if(fxrand()<1){
    if(fxrand()<1){ //<0 is ugly
      ...
      let posNeg = fxrand() < 0.5 ? -1 : 1
              ...
              this.startFlowerColor = new Color(`hsl(${this.startColorHue}, ${s}%, ${l}%)`)
    this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l-10}%)`)
    let gradient = this.startFlowerColor.range(this.c2, {space: "hsl", hue: "shorter"});
    let c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`)
    color1 = this.startFlowerColor.to("srgb") 
    color2 = this.c2.to("srgb")
    // color3 = gradient(1).to("srgb") 
      color3 = c3.to("srgb")
  ...
  if(fxrand()<1){
    if(fxrand()<1){ //<0 is ugly
      ...
      let posNeg = fxrand() < 0.5 ? -1 : 1
              ...
              this.startFlowerColor = new Color(`hsl(${((this.startColorHue+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`)
    this.c2 = new Color(`hsl(${((((this.startColorHue+(this.increment*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l-10}%)`)
    let gradient = this.startFlowerColor.range(this.c2, {space: "hsl", hue: "shorter"});
    let c3 = new Color(`hsl(${((((this.startColorHue+((this.increment*2)*posNeg))%360)+(fxrand()*5*posNegDir))%360)}, ${s}%, ${l}%)`)
    color1 = this.startFlowerColor.to("srgb") 
