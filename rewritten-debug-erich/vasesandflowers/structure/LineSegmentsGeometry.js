...
class LineSegmentsGeometry extends InstancedBufferGeometry {
	...
	setPositions( array ) {
		...
		this.attributes.instanceStart = new InterleavedBufferAttribute( instanceBuffer, 3, 0 ); // xyz
		this.attributes.instanceStart.needsUpdate = true;
		this.attributes.instanceEnd =  new InterleavedBufferAttribute( instanceBuffer, 3, 3 ); // xyz
